...
\newacronym{ccn}{CCN}{Convolutional Neural Network}
...
\input{standvanzaken}
\input{methodologie}
\input{systeemvereisten}
\input{selectieAlgoritmen}
\input{ocr}
\input{optimalisaties}
\input{architectuurPoc}
\input{conclusie}
...
\Gls{ccn}'s worden veelal gebruikt voor visuele machine learning
